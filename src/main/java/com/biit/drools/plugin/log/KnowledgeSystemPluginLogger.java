...
/*-
 * #%L
 * BiiT Knowledge Base Access For Drools Rules
 * %%
 ...
 */
public final class KnowledgeSystemPluginLogger {
    private static final Logger LOGGER = LoggerFactory.getLogger(KnowledgeSystemPluginLogger.class);

    private KnowledgeSystemPluginLogger() {
    }
